  ...
  const experiences = [
    {
      ...
      detailed: [
        ...
        'Full Stack JS Tech Lead @ Vixio: I led development of a compliance task management platform that helps users track and manage regulatory updates within their sector. The Vue front end used Tailwind and PrimeVue, with a NestJS backend exposing GraphQL for the client and REST endpoints to communicate with the Vixio Core Platform, using Prisma as the ORM. I also owned CI/CD via GitHub workflows into AWS, using S3, Fargate/ECS, PostgreSQL, Redis, SES, Cognito, and CloudWatch.',
